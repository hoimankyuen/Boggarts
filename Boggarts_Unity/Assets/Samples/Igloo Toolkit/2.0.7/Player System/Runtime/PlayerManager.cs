...
#pragma warning disable IDE0090 // Use 'new(...)'
        ...
        public void Setup()
        {
            ...
            if (HeadManager.instance.HeadTracking)
            {
                ...
                if (HeadManager.instance.headTrackingInput == HeadManager.HeadTrackingInput.Optitrack)
                {
                    ...
                    optitrack.Setup(optitrackControllerRigidBodyID, true, true, headManager.optitrackServerIPAddress, headManager.localServerIPAddress);
    ...
    public class DefaultLook : Look
    {
        ...
        public override void LookRotation(Transform character, Transform camera, bool invertPitch)
        {
            if (oscInput == lastOsc)
            {
                yRot = (Input.GetAxis("Mouse X") + Input.GetAxis("Right Stick X Axis")) * XSensitivity;
                xRot = (Input.GetAxis("Mouse Y") + Input.GetAxis("Right Stick Y Axis")) * YSensitivity;
